...
for question, options in questions:
    ...
    if question=="Q13.請問您比較偏好下列何種投資組合?":
        st.dataframe(df)
    if question=="Q4.請問您預計多久以後會使用到這筆錢?":
...
#Q14
st.write(question14)
initial_investment = st.number_input("單次投入多少元",value=0, step=10000) #slider("單次投入多少元 ", min_value=10_000, max_value=10_000_000,step=10_000)
monthly_investment = st.number_input("每月定期定額",value=0, step=1000) #slider("每月定期定額", min_value=0, max_value=1_000_000,step=1_000)
